...
C3 Permanent link to reproducible capsule & Zenodo DOI from the \texttt{v1.0.0} tag \emph{(archival deposit pending at posting)} \\
...
of the \texttt{v1.0.0} release will be archived with a DOI on Zenodo upon posting.
